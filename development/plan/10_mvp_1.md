# MVP I
 ...
 - Any other features required by Hackathon - see below
    - Leaning toward "Live Agents" category
 - Go for bonus points
...
1.  **📃 Text Description:** Summary of the Project’s features and functionality, technologies used, information about any other data sources used, and your findings and learnings as you worked through the project. 
2.  **👨‍💻 URL to your Public Code Repository:** Let us see how you built it!
    -   Include spin-up instructions in your README for the judges to see your project is reproducible 
3.  🖥️ **Proof of Google Cloud Deployment****:** You must demonstrate that the backend is running on Google Cloud with a short recording (separate from your demo) proving your Project’s backend is running on Google Cloud. Proof would either be (1) a quick screen recording that shows the behind-the-scenes of their app running on GCP (e.g. console logs or console view of a deployment) or (2) a link to a code file in their code repo that demonstrates use of Google Cloud services and APIs (e.g. API calls to Vertex AI endpoints)
4.  **🏗️ Architecture Diagram:** A clear visual representation of your system (e.g., how Gemini connects to your backend, database, and frontend)
